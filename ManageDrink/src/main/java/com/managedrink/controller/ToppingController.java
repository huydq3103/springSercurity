...
public class ToppingController {
    ...
    @PostMapping("/create")
    @PreAuthorize("(hasRole('USER') or hasRole('ADMIN')) and hasAnyAuthority('PERMISSION_WRITE')")
    ...
    @PreAuthorize("(hasRole('USER') or hasRole('ADMIN')) or hasAnyAuthority('PERMISSION_READ')")
    ...
    @PreAuthorize("(hasRole('USER') or hasRole('ADMIN')) and hasAnyAuthority('PERMISSION_DELETE')")
